...
CREATE TABLE `tbos` (
  ...
  `profissional` varchar(30) DEFAULT NULL,
  `especialidade` varchar(100) DEFAULT NULL,
  `valor` decimal(10,2) DEFAULT NULL,
  `id` int(11) NOT NULL,
  PRIMARY KEY (`os`),
  KEY `id` (`id`),
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tbpacientes` (`id`)
...
INSERT INTO `tbos` VALUES (1,'2023-03-10 15:32:19','Gripe','Fabiana',' Pneumologia',95.00,1);
